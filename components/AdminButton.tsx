...
export default function AdminButton() {
  ...
  useEffect(() => {
    async function check() {
      ...
      // Show admin button if user came from admin page (check original rolle or localStorage)
      setIsAdmin(true) // Always show for now - makes it easy to navigate
    }
    check()
  }, [])
  ...
  return (
    <a href="/admin"
      ...
      title="Zurueck zur Admin-Uebersicht">
